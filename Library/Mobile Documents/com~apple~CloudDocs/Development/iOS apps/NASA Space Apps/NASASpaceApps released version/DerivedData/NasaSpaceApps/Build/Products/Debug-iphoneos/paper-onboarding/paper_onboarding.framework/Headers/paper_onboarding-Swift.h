...
SWIFT_CLASS("_TtC16paper_onboarding25OnboardingContentViewItem")
...
@interface OnboardingContentViewItem (SWIFT_EXTENSION(paper_onboarding))
@end
...
SWIFT_CLASS("_TtC16paper_onboarding15PaperOnboarding")
@interface PaperOnboarding : UIView
/// The object that acts as the data source of the  PaperOnboardingDataSource.
@property (nonatomic, strong) IBOutlet id _Nullable dataSource;
...
/// \param itemsCount The number of items in PaperOnboarding.
///
///
/// returns:
/// Returns an initialized PaperOnboading object
- (nonnull instancetype)initWithItemsCount:(NSInteger)itemsCount OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


@interface PaperOnboarding (SWIFT_EXTENSION(paper_onboarding))
@end


@interface PaperOnboarding (SWIFT_EXTENSION(paper_onboarding))
/// Scrolls through the PaperOnboarding until a index is at a particular location on the screen.
/// \param index Scrolling to a curretn index item.
///
/// \param animated True if you want to animate the change in position; false if it should be immediate.
///
- (void)currentIndex:(NSInteger)index animated:(BOOL)animated;
@end
